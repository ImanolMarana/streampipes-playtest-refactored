...
public class ProvidedRestQueryParamConverter {
  ...
  public static SelectQueryParams getSelectQueryParams(ProvidedRestQueryParams params) {
    ...
    handleSelectParams(params, queryParameters);
    handleWhereParams(params, queryParameters);
    handleTimeIntervalParams(params, queryParameters);
    handleGroupByParams(params, queryParameters);
    handleOrderParams(params, queryParameters);
    handleLimitParams(params, queryParameters);
    handleOffsetParams(params, queryParameters);
    return queryParameters;
  }

  private static void handleSelectParams(ProvidedRestQueryParams params, SelectQueryParams queryParameters) {
  ...
  private static void handleWhereParams(ProvidedRestQueryParams params, SelectQueryParams queryParameters) {
  ...
  private static void handleTimeIntervalParams(ProvidedRestQueryParams params, SelectQueryParams queryParameters) {
  ...
  private static void handleGroupByParams(ProvidedRestQueryParams params, SelectQueryParams queryParameters) {
    if (params.has(SupportedRestQueryParams.QP_GROUP_BY)) {
  ...
  private static void handleOrderParams(ProvidedRestQueryParams params, SelectQueryParams queryParameters) {
  ...
  private static void handleLimitParams(ProvidedRestQueryParams params, SelectQueryParams queryParameters) {
  ...
  private static void handleOffsetParams(ProvidedRestQueryParams params, SelectQueryParams queryParameters) {
