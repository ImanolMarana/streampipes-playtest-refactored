...
public class DatatypeUtils {
  ...
  public static Class<?> getTypeClass(String value,
        ...
        if (NumberUtils.isParsable(value)) {
            return getNumberTypeClass(value, preferFloatingPointNumber);
    ...
    private static Class<?> getNumberTypeClass(String value, boolean preferFloatingPointNumber) {
        try {
            long longValue = Long.parseLong(value);
            return getIntegerType(longValue, preferFloatingPointNumber);
        } catch (NumberFormatException ignored) {
        }

        try {
            double doubleValue = Double.parseDouble(value);
            return getFloatingPointType(doubleValue, preferFloatingPointNumber);
        } catch (NumberFormatException ignored) {
        }
    ...
    private static Class<?> getIntegerType(long longValue, boolean preferFloatingPointNumber) {
        Class<?> numberClass = longValue > Integer.MAX_VALUE ? Long.class : Integer.class;
    ...
    private static Class<?> getFloatingPointType(double doubleValue, boolean preferFloatingPointNumber) {
        Class<?> numberClass = doubleValue > Float.MAX_VALUE ? Double.class : Float.class;
        if (preferFloatingPointNumber) {
